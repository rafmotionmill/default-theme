...
<?php the_post() ?>
			...
			<article id="post-<?php the_ID() ?>" class="<?php sandbox_post_class() ?>">
				...
				<footer class="entry-meta">
					<?php printf( __( 'This entry was written by %1$s, posted on <time class="published" datetime="%2$s" pubdate>%4$s at %5$s</time>, filed under %6$s%7$s. Bookmark the <a href="%8$s" title="Permalink to %9$s" rel="bookmark">permalink</a>. Follow any comments here with the <a href="%10$s" title="Comments RSS to %9$s" rel="alternate" type="application/rss+xml">RSS feed for this post</a>.', 'sandbox' ),
						'<span class="author vcard"><a class="url fn n" href="' .get_author_posts_url( get_the_author_meta( 'ID' )) . '" title="' . sprintf( __( 'View all posts by %s', 'sandbox' ), $authordata->display_name ) . '">' . get_the_author_meta('nickname') . '</a></span>',
						get_the_time('Y-m-d'),
						get_the_time('H:i:sO'),
						the_date( '', '', '', false ),
						get_the_time(),
